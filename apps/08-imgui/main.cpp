...
void LoadFontsTexture()
{
    ...
    ImFont* my_font6 = io.Fonts->AddFontFromFileTTF("extra_fonts/ARIALUNI.TTF", 20.f, io.Fonts->GetGlyphRangesJapanese());  // Default + Hiragana, Katakana, Half-Width, Selection of 1946 Ideographs
//    ImFont* my_font1 = io.Fonts->AddFontDefault();
//    ImFont* my_font2 = io.Fonts->AddFontFromFileTTF("extra_fonts/Karla-Regular.ttf", 15.0f);
//    ImFont* my_font3 = io.Fonts->AddFontFromFileTTF("extra_fonts/ProggyClean.ttf", 13.0f); my_font3->DisplayOffset.y += 1;
//    ImFont* my_font4 = io.Fonts->AddFontFromFileTTF("extra_fonts/ProggyTiny.ttf", 10.0f); my_font4->DisplayOffset.y += 1;
//    ImFont* my_font5 = io.Fonts->AddFontFromFileTTF("extra_fonts/Karla-Regular.ttf", 15.f, io.Fonts->GetGlyphRangesDefault());  // Basic Latin, Extended Latin 
    //ImFont* my_font6 = io.Fonts->AddFontFromFileTTF("extra_fonts/DroidSansJapanese.ttf", 20.f, io.Fonts->GetGlyphRangesJapanese());  // Default + Hiragana, Katakana, Half-Width, Selection of 1946 Ideographs
//    ImFont* my_font7 = io.Fonts->AddFontFromFileTTF("extra_fonts/ARIALUNI.TTF", 20.f, io.Fonts->GetGlyphRangesChinese());   // Include full set of about 21000 CJK Unified Ideographs
