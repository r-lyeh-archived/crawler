...
void window::init(const uint32_t width, const uint32_t height, const bool is_fullscreen, const std::string &title)
{
  m_message_callback = std::bind(&window::_process_message, this, std::placeholders::_1);
